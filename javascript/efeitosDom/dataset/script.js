...
tabContent2[0].classList.add('show-right')


function activeTab(index){
    tabContent2.forEach((content) => {
        content.classList.remove('ativo')
        content.classList.remove('show-right')
        content.classList.remove('show-down')

    });
    tabContent2[index].classList.add('ativo')
    console.log(tabContent[index].dataset.anime)
    if (tabContent[index].dataset.anime === 'show-right'){
        tabContent2[index].classList.add('show-right')

    }
    if (tabContent[index].dataset.anime === 'show-down'){
        tabContent2[index].classList.add('show-down')
